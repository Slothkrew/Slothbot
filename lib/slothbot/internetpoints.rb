...
module Slothbot
  ...
  class InternetPointsModule
    ...
    def add(from, to, amount, reason)
      ...
      return "You can max hand out #{max_points - given_last_day} more points today." if given_last_day + amount > max_points    
